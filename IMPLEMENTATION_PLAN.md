...
**Status:** In progress (14/28 checklist items) — Phase 1 formatter core + 3.1 unit/golden tests landed (`1930576`); registry/CLI wiring, 3.2 CLI tests, and docs pending.
...
**Status:** Partial — 3.1 unit/output tests done (`1930576`); 3.2 CLI/process tests pending (need Phase 2 wiring)
...
**Remaining effort:** Phase 1 done (`1930576`); Phase 2 is three wiring points in `internal/cli/analyze.go`; Phase 3 remainder is 3.2 CLI/process tests; Phase 4 is small README work with one blocked spec-delta item; Phase 5 is gate runs.
